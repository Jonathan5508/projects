...
export enum CDN_URL {
  BASE = 'https://chat-app-jonathan.sfo3.cdn.digitaloceanspaces.com/',
  ORIGINAL = 'https://chat-app-jonathan.sfo3.cdn.digitaloceanspaces.com/original/',
  PREVIEW = 'https://chat-app-jonathan.sfo3.digitaloceanspaces.com/preview/',
}
